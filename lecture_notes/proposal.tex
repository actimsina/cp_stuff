...
% \begin{frame}[t]\frametitle{Activity-on-node example}
%     \begin{figure}
%     \centering
%     \includegraphics[width = 0.9\textwidth]{activity_sequencing}
%     \caption{An example of simple activity-on-node diagram}
%   \end{figure}
% \end{frame}
